...
def creditCards(paramsEst,
    ...
    bin_maps: dict, key is param names, value is pandas dataframe contains map table
    red_maps: dict, key is param names, value is pandas dataframe contains redCats table
    woe_maps: dict, key is param names, value is also a dict contain binNumber-woe
