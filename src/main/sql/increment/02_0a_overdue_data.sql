...
--一度关联自身
drop table overdue_cnt_self_instant;
create table overdue_cnt_self_instant as 
-- 一度关联自身_订单数量     
...
--合并数据  一度关联自身
drop table  lkl_card_score.overdue_cnt_self_sum_instant;
create table  lkl_card_score.overdue_cnt_self_sum_instant  as
select order_src,
