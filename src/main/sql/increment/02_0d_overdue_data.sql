...
-- 一度_历史3+数量            
-- 一度_历史30+数量    
drop table overdue_cnt_2_tmp_instant;
create table overdue_cnt_2_tmp_instant as 
select c.order_src,
        'overdue0' title
...
--合并一度关联 逾期数据(排除自身)
drop table  lkl_card_score.overdue_cnt_2_instant;
create table  lkl_card_score.overdue_cnt_2_instant  as
select order_src,
